...
Source2:          redis-server.init
# Update configuration
Patch0:           %{name}-2.6.2-redis.conf.patch
...
%preun
if [ $1 = 0 ]; then
  /sbin/service redis-server stop &> /dev/null
  /sbin/chkconfig --del redis-server &> /dev/null
fi
...
%changelog
* Tue Oct 30 2012 Indra Kurniawan <kurniawan.indra@merahciptamedia.co.id> - 2.6.2-1
- Update to redis 2.6.2
